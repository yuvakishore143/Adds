  ...
  const fetchingData = async() =>{
    ...
    const options = {
      ...
      headers:{
        ...
        body :  JSON.stringify({searchVal : ele})
    }
      let response = await fetch('http://localhost:4000/' , options)
